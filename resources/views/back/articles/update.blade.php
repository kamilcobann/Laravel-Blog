                        ...
                        <div class="card-body">
                           <form method="post" action="{{route('admin.articles.update',$article->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <img src="{{asset($article->image)}}" width="300" class="rounded-2 img-thumbnail">
                                <input type="file" name="image" id="image" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>İçerik</label>
                                <textarea rows="4" name="content" id="editor" class="form-control" required>{{$article->content}}</textarea>
                            </div>
